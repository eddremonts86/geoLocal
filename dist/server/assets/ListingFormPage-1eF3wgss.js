...
import { t as createListingFn } from "./admin-listings.fn-CZig8Yyg.js";
...
import { i as VEHICLE_SUBCATEGORIES, n as PROPERTY_SUBCATEGORIES, r as SERVICE_SUBCATEGORIES } from "./types-C9x-qFiw.js";
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsx("span", {
							...
							children: "02 · Catalog · New listing"
						}),
						/* @__PURE__ */ jsx("h1", {
							className: "font-display text-[clamp(2rem,1.5rem+1.6vw,2.75rem)] font-medium leading-none tracking-tight text-foreground",
			...
			/* @__PURE__ */ jsx("nav", {
				...
				children: STEPS.map((label, i) => {
					...
					return /* @__PURE__ */ jsxs("button", {
						...
						children: [
							/* @__PURE__ */ jsx("span", {
								className: `flex h-6 w-6 items-center justify-center font-display text-xs font-medium tabular-nums transition-colors ${isDone ? "bg-foreground text-background" : isCurrent ? "bg-(--ink-1) text-background" : "bg-(--surface-2) text-(--ink-3) group-hover:bg-(--surface-3)"}`,
								children: isDone ? /* @__PURE__ */ jsx(Check, {
									className: "h-3 w-3",
									strokeWidth: 2
								}) : i + 1
							}),
							/* @__PURE__ */ jsx("span", {
								className: `meta-label hidden sm:inline ${isCurrent ? "text-foreground" : "text-(--ink-3) group-hover:text-foreground"}`,
								children: label
							}),
							i < STEPS.length - 1 && /* @__PURE__ */ jsx("div", {
								className: "ml-1 hidden h-px flex-1 bg-(--line-1) sm:block",
								"aria-hidden": true
							})
						]
					}, label);
