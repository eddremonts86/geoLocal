...
function Footer() {
	...
	return /* @__PURE__ */ jsx("footer", {
		className: "mt-24 w-full bg-background md:mt-32",
		children: /* @__PURE__ */ jsxs("div", {
			className: "w-full py-16 md:py-24",
			children: [
				/* @__PURE__ */ jsxs("div", {
					className: "mb-16 flex items-baseline justify-between gap-6 px-[35px] md:mb-20",
					children: [
						/* @__PURE__ */ jsx("span", {
				...
				/* @__PURE__ */ jsxs("div", {
					className: "mx-auto grid max-w-[1400px] grid-cols-12 gap-x-6 gap-y-12 px-6 md:px-10",
					children: [
						/* @__PURE__ */ jsxs("div", {
				...
				/* @__PURE__ */ jsxs("div", {
					className: "mt-16 flex flex-col items-start justify-between gap-4 px-[35px] md:mt-20 md:flex-row md:items-baseline",
